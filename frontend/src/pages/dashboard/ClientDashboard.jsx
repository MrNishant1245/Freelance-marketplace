        ...
        {activeTab === 'overview' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div className="fd-greeting-row-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div className="fd-date-selector-pill" style={{ display: 'flex', alignItems: 'center', gap: 8, background: '#111625', border: '1px solid #1d2433', borderRadius: 99, padding: '8px 16px', fontSize: 12.5, fontWeight: 600, color: '#f8fafc', cursor: 'pointer' }} onClick={() => toast.success('Date filter toggled!')}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>
                  <span style={{ fontSize: '14px', fontWeight: 700, color: '#fff' }}>Weekly Period</span>
                  <span style={{ fontSize: '12px', color: '#94a3b8', fontWeight: 500 }}>14 Jul, 2026 – 20 Jul, 2026</span>
                </div>
              </div>
            </div>
