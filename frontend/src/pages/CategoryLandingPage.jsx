    ...
    case 'Poster':
      return (
        <svg {...svgStyle} viewBox="0 0 24 24">
          ...
          <polyline points="10 17 14 13 18 17" />
        </svg>
      );

    // ── Heart / social media engagement ──
    case 'Social Media':
    case 'Google Ads':
    case 'Facebook Ads':
